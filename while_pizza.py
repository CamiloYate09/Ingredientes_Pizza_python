...
def capturar():
    global lista
    lista = []
    n = int(input("Cuantos Ingredientes va a tener tu lista \n"))

    for i in range(0,n):
        print("Ingresa el Ingrediente del indice", i)
        elemento = input()
...
def principal():
    ...
    while(opcion != 6):
        print("1. INGRESAR UN INGREDIENTE A TU RECETA")
        print("2. MOSTRAR UNA LOS INGREDIENTES")
        print("3. QUIERES AGREGAR MAS UN INGREDIENTES A LA LISTA")
        print("4. QUIERES ELIMINAR UN INGREDIENTE DE LA LISTA")
        print("5. QUIERES MODIFICAR UN INGREDIENTE DE LA LISTA")
        print("6. SALIR")
